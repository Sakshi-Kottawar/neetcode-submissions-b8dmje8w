class Solution {
    public int openLock(String[] deadends, String target) {
        ...
        while(!dq.isEmpty()){
            ...
            for(int i=0;i<size;i++){
                ...
                List<String> previousStates=getAllPossiblePreviousStates(curr,deadends,hs);
                // System.out.println("current state "+curr);
                // System.out.println("previous state "+previousStates);
    ...
    private   List<String> getAllPossiblePreviousStates(String str,String[] deadends,Set<String> hs){
